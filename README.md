...
I've created this library as a wrapper around the native array datatype available in VGL. The functions and parameters are modeled after JavaScript's built-in `Array` object. I have written [a blog post that goes into more detail](https://ianc.blog/2019/06/25/functional-vgl-list-class.html).
...
| append_array                 |            |                                                                          |
|                              | _OK_       | `list . toString ( ) = []`                                               |
|                              | _OK_       | `list . append_array ( arr, 1 ) . toString ( ) = [x,y,z]`                |
|                              | _OK_       | `list . append_array ( arr, 2 ) . toString ( ) = [x,y,z,a,b,c]`          |
| clear                        |            |                                                                          |
...
|                              | _OK_       | `list . toString ( ) = [x,y]`                                            |
| distinct                     |            |                                                                          |
|                              | _OK_       | `list . toString ( ) = [a,b,c,b]`                                        |
|                              | _OK_       | `list . distinct ( ) = [a,b,c]`                                          |
|                              | _OK_       | `list . append ( 'a' ) = [a,b,c,a]`                                      |
|                              | _OK_       | `list . distinct ( ) = [a,b,c]`                                          |
| get                          |            |                                                                          |
...
|                              | _OK_       | `list . remove ( 1 ) . toString ( ) = [b,c,d]`                           |
|                              | _OK_       | `list . remove ( 3 ) . toString ( ) = [b,c]`                             |
| reverse                      |            |                                                                          |
|                              | _OK_       | `list . toString ( ) = [a,b,c,d]`                                        |
